...
## Estado
Aceptada, alcance corregido por **ADR-009**: el Radar de Espera sigue siendo la funcionalidad diferenciadora y el activo de datos central, pero deja de ser el producto completo — se anida dentro de un recorrido de 5 etapas que incluye descubrimiento y comparación personalizada. Ver ADR-009 para el razonamiento de por qué esto además acelera (no diluye) el propio Radar de Espera.
